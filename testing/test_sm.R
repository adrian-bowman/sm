...
#---------------------------------------------------------------
test_label("One covariate", test.prompt)
#---------------------------------------------------------------
...
#---------------------------------------------------------------
test_label("Illustration of basis weights", test.prompt)
#---------------------------------------------------------------
...
#---------------------------------------------------------------
test_label("Periodic terms", test.prompt)
#---------------------------------------------------------------
...
#---------------------------------------------------------------
test_label("Two covariates", test.prompt)
#---------------------------------------------------------------
...
#---------------------------------------------------------------
test_label("Three covariates", test.prompt)
#---------------------------------------------------------------
...
#---------------------------------------------------------------
test_label("Additive models", test.prompt)
#---------------------------------------------------------------
...
#---------------------------------------------------------------
test_label("EA data", test.prompt)
#---------------------------------------------------------------
...
#---------------------------------------------------------------
test_label("Fixed point", test.prompt)
#---------------------------------------------------------------
...
#---------------------------------------------------------------
test_label("Monotonic", test.prompt)
#---------------------------------------------------------------
...
#---------------------------------------------------------------
test_label("Toluene data from Shell", test.prompt)
#---------------------------------------------------------------

# d <- read.table("~/research/daniel/Shell data/Toluene.txt", header = TRUE)
# attach(d)
# 
# library(MASS)
