...
sm(Score1 ~ s(Longitude))
sm(Score1 ~ s(Longitude, df = 4))
sm(Score1 ~ s(Longitude, df = 10))
sm(Score1 ~ s(Longitude), se = TRUE, panel = TRUE)
sm(Score1 ~ s(Longitude), lambda = 16.6)

model <- sm(Score1 ~ s(Longitude, lambda = 10000000))
model$df.model
model <- sm(Score1 ~ s(Longitude, df = 20))
model$lambda

sm(Longitude, Score1)
sm.regression(Longitude, Score1)

sm.regression(Longitude, Score1, panel = TRUE, se = TRUE, col = "blue")
